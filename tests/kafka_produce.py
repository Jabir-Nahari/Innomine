...
print("Kafka producer test starting...")
...
messages = [
    (
        ...
        {"sensor": "ds18b20", "recorded_at": time.time(), "celsius": 60.0, "fahrenheit": 140.0, "is_simulated": True},
    ),
    (
        os.getenv("SCD40_KAFKA_TOPIC", "scd40.readings"),
        {"sensor": "scd40", "recorded_at": time.time(), "co2_ppm": 3000.0, "temperature_c": 25.0, "temperature_f": 77.0, "humidity_rh": 40.0, "is_simulated": True},
    ),
    (
        os.getenv("MPU6050_KAFKA_TOPIC", "mpu6050.readings"),
        {"sensor": "mpu6050", "recorded_at": time.time(), "temperature_c": 55.0, "temperature_f": 131.0, "accel_x_g": 0.0, "accel_y_g": 0.0, "accel_z_g": 1.0, "gyro_x_dps": 0.0, "gyro_y_dps": 0.0, "gyro_z_dps": 0.0, "is_simulated": True},
    ),
]
